<template>
  <div class="bg-white rounded shadow p-6 m-4 w-full lg:w-3/4 lg:mx-w-lg">
      <div class="mb-4">
          <h1 class="text-grey-darkest">Todo List</h1>
          <div class="flex mt-4">
              <input class="shadow appearance-none border rounded w-full py-2 px-3 mr-4 text-gray-darker" v-model="newTodo" placeholder="Add Todo">
